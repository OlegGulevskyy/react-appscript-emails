...
console.log("preprocess.ts");
// wtf, why is TS not playing nicely with these imports?
const _trav = _traverse.default;
type Traverse = typeof _trav & { default: typeof _trav };
const traverse = (_trav as Traverse).default;

const _gen = _generator.default;
type Generator = typeof _gen & { default: typeof _gen };
const generator = (_gen as Generator).default;

export const preprocessReactFiles = ({
  reactFilesPath,
}: Pick<RunProps, "reactFilesPath">) => {
